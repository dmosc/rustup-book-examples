...
mod tests {
    ...
    fn load_query_and_file_path() {
        ...
        let parsed_args = args_parser::query_and_file_path(&args).unwrap();
        assert_eq!(
            parsed_args,
            args_parser::Config::new(String::from("query"), String::from("file_path"))
        );
    }
    ...
    fn no_query_arg() {
        ...
        args_parser::query_and_file_path(&args).unwrap();
    }
